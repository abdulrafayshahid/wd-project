  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Edit User') }}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <?php  $userroles = \App\Models\RolePermission::where('user_id',auth()->user()->id)->get(); ?>

      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('organizer.organizer_management.update_user') }}" method="POST" enctype="multipart/form-data">
