...
@section('content')
                    ...
                    <tbody>
                      @foreach ($roles as $role)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-info btn-sm" href="{{ route('organizer.organizer_management.role.permissions', ['id' => $role->id]) }}">
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block" action="{{ route('organizer.organizer_management.delete_role', ['id' => $role->id]) }}" method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('organizer.role-permission.create')

  {{-- edit modal --}}
  @include('organizer.role-permission.edit')
@endsection
