              ...
              <form id="eventForm" action="{{ route('organizer.event_management.store_event') }}" method="POST"
                  ...
                  <div class="col-lg-12">
                    <div class="form-group mt-1">
                      ...
                      <div class="selectgroup w-100">
                        ...
                        <label class="selectgroup-item">
                          <input type="radio" name="date_type" value="new" class="selectgroup-input eventDatesam">
                          <span class="selectgroup-button">{{ __('Days Event') }}</span>
                        </label>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="form-group">
                      <table class="table table-bordered ">
                        ...
                        <tr>
                          ...
                          <th>{{ __('End Date') }}</th>
                          <th>{{ __('End Time') }}</th>
                          <th><a href="javascrit:void(0)" class="btn btn-success addDateRow2"><i
                ...
                <div class="row">
                  <div class="col-lg-12 d-none" id="multiple_dates2">
                    <div class="form-group">
                      <table class="table table-bordered event_table">
                        <thead>
                        <tbody>
                        <tr id="dateEventTR">
                          <td>
                            <div class="form-group">
                              <label for="">{{ __('Start Date') . '*' }}</label>
                              <input type="date" id="start_date" name="m_start_date1" class="form-control">
                            </div>
                          </td>
                          ...
                          <td>
                            <div class="form-group">
                              <label for="">{{ __('End Date') . '*' }} </label>
                              <input type="date" id="end_date" name="m_end_date1" class="form-control">
                            </div>
                          </td>
                        </tr>
                        </tbody>
                    ...
                    <div class="version">
                      <div class="version-header" id="heading{{ $language->id }}">
                        <h5 class="mb-0">
                          <button type="button" class="btn btn-link" data-toggle="collapse"
                                  data-target="#collapse{{ $language->id }}" onclick="setDiv()"
                      ...
                      <div id="collapse{{ $language->id }}"
                        ...
                        <div class="version-body">
                            ...
                            <div class="row">
                              <div class="col-lg-8">
                                <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                  ...
                                  <input type="text" id="location" name="{{$language->code}}_address"
                                         class="address form-control" placeholder="Enter Address">
                                  @if($loop->iteration == 1)
                              ...
                              <div class="col-lg-12">
                                <div class="form-group">
                                  <input type="text" class="placeInput" placeholder="Search for a place">
                                  <div class="map">
                              ...
                              <div class="col-lg-4">
                                <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                  ...
                                  <input type="text" id="state" name="{{$language->code}}_state" class="form-control"
                              ...
                              <div class="col-lg-4">
                                <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                  ...
                                  <input type="text" id="city" name="{{$language->code}}_city" class="form-control"
                              ...
                              <div class="col-lg-4">
                                <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                  ...
                                  <input type="text" id="zip" placeholder="Enter Zip/Post Code"
                                         name="{{$language->code}}_zip_code" class="form-control">
                                </div>
                              </div>
                            </div>
                          @endif
                            ...
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea id="descriptionTmce{{ $language->id }}"
                                          class="form-control summernote {{ $language->direction == 1 ? 'rtl text-right' : '' }}"
                          ...
                          <div class="modal fade" id="addEntryModal{{$language->code}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                               aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                              <div class="modal-content rounded-0">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="myModalLabel{{$language->code}}">{{__('Add Transport')}}</h5>
                                ...
                                <div class="modal-body p-4 px-5">
                                  ...
                                  <div class="main-content">
                                    ...
                                    <div class="form-group">
                                      <label for="transport_select" class="form-label">{{__('Transport')}}</label>
                                      <select class="form-control" name="{{$language->code}}_transport_select" id='transport_select'>
                                        <option disabled="disabled" selected="selected">{{ __('Select...') }}</option>
                                        <optgroup label="{{ __('2 wheels') }}">
                                          <option value="bicycle">{{ __('Bike') }}</option>
                                          <option value="segway">{{ __('Segway') }}</option>
                                          <option value="electric_bicycle">{{ __('Electric bike') }}</option>
                                          <option value="mountain_bike">{{ __('Mountain bike') }}</option>
                                          <option value="motorcycle">{{ __('Motorcycle') }}</option>
                                          <option value="scooter">{{ __('Scooter') }}</option>
                                        </optgroup>
                                        <optgroup label="{{ __('Car / bus') }}">
                                          <option value="car">{{ __('Car') }}</option>
                                          <option value="limousine">{{ __('Limousine') }}</option>
                                          <option value="jeep_suv">{{ __('Jeep / SUV') }}</option>
                                          <option value="van">{{ __('Van') }}</option>
                                          <option value="bus_coach">{{ __('Bus / coach') }}</option>
                                          <option value="electric_car">{{ __('Electric car') }}</option>
                                          <option value="vintage_car">{{ __('Vintage car') }}</option>
                                          <option value="black_cab">{{ __('Black cab') }}</option>
                                        </optgroup>
                                        <optgroup label="{{ __('Water') }}">
                                          <option value="sailboat">{{ __('Sailboat') }}</option>
                                          <option value="ferry">{{ __('Ferry') }}</option>
                                          <option value="gondola">{{ __('Gondola') }}</option>
                                          <option value="duck_boat">{{ __('Duck boat') }}</option>
                                          <option value="sightseeing_cruise">{{ __('Sightseeing cruise') }}</option>
                                          <option value="water_taxi">{{ __('Water taxi') }}</option>
                                          <option value="jet_ski">{{ __('Jetski') }}</option>
                                          <option value="river_boat">{{ __('Riverboat') }}</option>
                                          <option value="kayak">{{ __('Kayak') }}</option>
                                          <option value="raft">{{ __('Raft') }}</option>
                                          <option value="catamaran">{{ __('Catamaran') }}</option>
                                          <option value="speed_boat">{{ __('Speedboat') }}</option>
                                          <option value="yacht">{{ __('Yacht') }}</option>
                                          <option value="canoe">{{ __('Canoe') }}</option>
                                          <option value="stand_up_paddle_board">{{ __('Paddleboard') }}</option>
                                          <option value="surfboard">{{ __('Surfboard') }}</option>
                                          <option value="submarine">{{ __('Submarine') }}</option>
                                          <option value="other_water_transport">{{ __('Other water transport') }}</option>
                                          <option value="glass_bottom_boat">{{ __('Glass bottom boat') }}</option>
                                          <option value="lake_cruise">{{ __('Lake cruise') }}</option>
                                          <option value="banana_boat">{{ __('Banana boat') }}</option>
                                          <option value="beer_boat">{{ __('Beer boat') }}</option>
                                          <option value="air_boat">{{ __('Airboat') }}</option>
                                          <option value="dhow">{{ __('Dhow') }}</option>
                                        </optgroup>
                                        <optgroup label="{{ __('Rail transport') }}">
                                          <option value="train">{{ __('Train') }}</option>
                                          <option value="tram">{{ __('Tram') }}</option>
                                          <option value="subway">{{ __('Subway') }}</option>
                                        </optgroup>
                                        <optgroup label="{{ __('Air') }}">
                                          <option value="helicopter">{{ __('Helicopter') }}</option>
                                          <option value="airplane">{{ __('Airplane') }}</option>
                                          <option value="balloon">{{ __('Balloon') }}</option>
                                          <option value="glider">{{ __('Glider') }}</option>
                                        </optgroup>
                                        <optgroup label="{{ __('Public transport') }}">
                                          <option value="public">{{ __('Public transportation') }}</option>
                                        </optgroup>
                                        <optgroup label="{{ __('Other') }}">
                                          <option value="cable_car">{{ __('Cable car') }}</option>
                                          <option value="quad_atv">{{ __('Quad ATV') }}</option>
                                          <option value="pedicab_rickshaw">{{ __('Pedicab / rickshaw') }}</option>
                                          <option value="horse_carriage">{{ __('Horse carriage') }}</option>
                                          <option value="camel">{{ __('Camel') }}</option>
                                          <option value="snowmobile">{{ __('Snowmobile') }}</option>
                                          <option value="sled">{{ __('Sled') }}</option>
                                          <option value="other_animal">{{ __('Other animal') }}</option>
                                          <option value="beer_bike">{{ __('Beer bike') }}</option>
                                          <option value="trike">{{ __('Trike') }}</option>
                                          <option value="tuk_tuk">{{ __('Tuk tuk') }}</option>
                                          <option value="motorized_tuk_tuk">{{ __('Motorized tuk tuk') }}</option>
                                          <option value="golf_cart">{{ __('Golf cart') }}</option>
                                          <option value="on_foot">{{ __('On foot') }}</option>
                                          <option value="horse">{{ __('Horse') }}</option>
                                          <option value="trolley">{{ __('Trolley') }}</option>
                                        </optgroup>
                                      </select>

                                    </div>
                                    <div class="form-group">
                                      <label for="type_of_share" class="form-label">{{__("Private / Shared")}}</label>
                                      <div class="radio-buttons">
                                        <label>
                                          <input type="radio" name="{{$language->code}}_type_of_share" value="private">
                                          {{__("Private")}}
                                        </label>
                                        <label>
                                          <input type="radio" name="{{$language->code}}_type_of_share" value="shared">
                                          {{__("Shared")}}
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <button onclick="getEntry('{{$language->code}}')" type="button" class="btn btn-primary">{{__('Add')}}</button>
                                    </div>
      ...
      <div class="modal-content rounded-0">
        <div class="modal-body p-4 px-5">
          ...
          <div class="main-content text-center">
            ...
            <form action="#">
              <label for="" style="text-transform: capitalize;">admin will take 10% commission for features
                event</label>
  ...
  <script>
    ...
    $('.eventDateType').on('change', function () {
      ...
      if (value == 'multiple') {
        ...
        $('#multiple_dates2').addClass('d-none');
        $('#multiple_dates').removeClass('d-none');
        $('.countDownStatus').addClass('d-none');
        $('.event_type_row2').addClass('d-none');
      } else {
        $('#single_dates').removeClass('d-none');
        $('#multiple_dates2').addClass('d-none');
        $('#multiple_dates').addClass('d-none');
        $('.countDownStatus').removeClass('d-none');
        $('.event_type_row2').removeClass('d-none');
      }
    });

    $('.eventDatesam').on('change', function () {

      let value = $(this).val();
      if (value == 'new') {
        $('#single_dates').addClass('d-none');
        $('#multiple_dates').addClass('d-none');
        $('#multiple_dates2').removeClass('d-none');
        // $('.countDownStatus').addClass('d-none');
        // $('.event_type_row').addClass('d-none');
      } else {
        // $('#single_dates').removeClass('d-none');
        $('#multiple_dates2').addClass('d-none');
        // $('.countDownStatus').removeClass('d-none');
        // $('.event_type_row').removeClass('d-none');
      }
    });
    
    function initMap() {
    var mapElements = document.getElementsByClassName('map');
    var input = document.getElementsByClassName('placeInput'); 

    function setupMap(mapElement,input) {
        ...
        // Assuming the input is right after the map div
    ...
    for (var i = 0; i < mapElements.length; i++) {
        setupMap(mapElements[i],input[i]);
    }
}
...
function onMarkerDragEnd(marker) {
    ...
    $(document).ready(function () {
      ...
      $('.rtl').eq(9).children().closest('label').text("مواصلات");

      $('.rtl').eq(9).find('b').text("هل تستخدم وسائل النقل لهذا النشاط؟");
      $('.rtl').eq(9).find('p').text("حدد ما إذا كان سيتم استخدام وسائل النقل أثناء النشاط. يمكن إضافة وسائل النقل المتعلقة بخدمات النقل والتوصيل لاحقًا.");
      $('.rtl').eq(11).find('label').text("لا");
      $('.rtl').eq(10).find('label').text("نعم");
      $('.rtl').eq(12).children().closest('label').text("الكلمات المفتاحية للحدث*");
      $('.rtl').eq(12).children().closest('textarea').attr("placeholder", "أدخل الكلمات الأساسية ميتا");
      $('.rtl').eq(13).children().closest('label').text("وصف تعريف الحدث*");
      $('.rtl').eq(13).children().children().closest('input').attr("placeholder", "أدخل وصف التعريف");
      $('.rtl').eq(14).children().closest('label').text("وصف التعريف للحدث");
      $('.rtl').eq(14).children().closest('textarea').attr("placeholder", "وصف التعريف للحدث");
...
<p class='font-weight-bold' data-val='${transport_val}'>${transport_select}</p>
    ...
    $('tbody').on('click', '.deleteRowStartEndTime', function () {

      $(this).closest('tr').remove();
    })
    // $('tbody').on('click', '.addRowStartEndTime', function () {
    function clickfun(currentDateValue){
      // alert(currentDateValue)
      // var currentDateValue = "dfh"
      ...
      var tr = `<tr>
                ...
                <td>
                  <div class="form-group">
                    ...
                    <input type="time" name="m_start_time_day['`+currentDateValue+`'][]" class="form-control">
                  </div>
                </td>
                <td>
                  <div class="form-group">
                    <label for="">End Time *</label>
                    <input type="time" name="m_end_time_day['`+currentDateValue+`'][]" class="form-control">
                  </div>
                </td>
                <td>
                <a href="javascrit:void(0)" class="btn btn-danger deleteRowStartEndTime"><i
                                  class="fas fa-minus"></i></a>
                </td>
              </tr>`;
      // $(this).insertAfter($(this).parents().closest('tr')).append(tr);
      // $(".addRowStartEndTime"+currentDateValue).closest('tr').append(tr);
      $(tr).insertAfter($(".addRowStartEndTime"+currentDateValue).closest('tr'));
    ...
    $('#end_date').on('change', function () {
      ...
      var selectedDate = new Date(date);
      var selectedEndDate = new Date(end_date);
      var days = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
      var tr ='';
      for (var day = selectedDate; day <= selectedEndDate; day.setDate(day.getDate() + 1)) {
        var currentDateValue1 = new Date(day);
        var currentDateValue = currentDateValue1.getFullYear()+'-'+("0" + (currentDateValue1.getMonth() + 1)).slice(-2)+ '-'+ ("0" + (currentDateValue1.getDate())).slice(-2);
        ...
        // let formatDay = day + "-" + month + "-" + year;
        var selectedDay = days[day.getDay()];
        tr = tr + `<tr>
                <td>
                  <div class="form-group">
                  <label for="">Day</label>
                  <input type="text" class="form-control show_date" readonly value="`+selectedDay+`">
                  <input type="hidden" name="currentDate" value="`+currentDateValue+`" class="form-control">
                ...
                <td>
                <button class="btn btn-success addRowStartEndTime`+currentDateValue+`" onclick="clickfun('`+currentDateValue+`')"><i
                                class="fas fa-plus-circle"></i></button>
                </td>
              </tr>`;
      }

      $('#dateEventTR').parent('tbody').append(tr);
    });
  ...
  <!-- Load the Google Maps JavaScript API asynchronously with the callback -->
  <script async defer
          src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDB8ahpPhHkuWIh0JyxSg3uALTj9ynOS74&callback=initMap&libraries=places"></script>
@endsection
