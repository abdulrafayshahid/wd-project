                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mx-auto">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>{{ __('Comission Percentage') . '*' }}</label>
                                            <div class="input-group mb-2">
                                                <input type="number" name="percent_comission" class="form-control ltr"
                                                    value="{{ $data->percent_comission }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-8 mx-auto">
                                <h2 class="mt-3 text-warning">{{ __('Terms & Conditions') }}</h2>
                                <hr>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="terms_and_condition" id="" cols="30" rows="10">{{ $data->terms_and_condition }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
