...
Route::prefix('/organizer')->middleware('auth:organizer', 'Deactive:organizer', 'EmailStatus:organizer')->group(function () {
  ...
  // organizer role prmission routes start

  Route::get('/role-permissions', 'BackEnd\Organizer\OrganizerRolePermissionController@index')->name('organizer.organizer_management.role_permissions');

  Route::post('/store-role', 'BackEnd\Organizer\OrganizerRolePermissionController@store')->name('organizer.organizer_management.store_role');

  Route::get('/role/{id}/permissions', 'BackEnd\Organizer\OrganizerRolePermissionController@permissions')->name('organizer.organizer_management.role.permissions');

  Route::post('/role/{id}/update-permissions', 'BackEnd\Organizer\OrganizerRolePermissionController@updatePermissions')->name('organizer.organizer_management.role.update_permissions');

  Route::post('/update-role', 'BackEnd\Organizer\OrganizerRolePermissionController@update')->name('organizer.organizer_management.update_role');

  Route::post('/delete-role/{id}', 'BackEnd\Organizer\OrganizerRolePermissionController@destroy')->name('organizer.organizer_management.delete_role');

  // organizer role prmission routes close

    // organizer User routes start

    Route::get('/registered-user', 'BackEnd\Organizer\OrganizerUserController@index')->name('organizer.organizer_management.registered_user');

    Route::post('/store-user', 'BackEnd\Organizer\OrganizerUserController@store')->name('organizer.organizer_management.store_user');

    Route::post('/user/{id}/update-status', 'BackEnd\Organizer\OrganizerUserController@updateStatus')->name('organizer.organizer_management.user.update_status');

    Route::post('/update-user', 'BackEnd\Organizer\OrganizerUserController@update')->name('organizer.organizer_management.update_user');

    Route::post('/delete-user/{id}', 'BackEnd\Organizer\OrganizerUserController@destroy')->name('organizer.organizer_management.delete_user');
  
  
    // organizer User routes end
  ...
  */
  ...
  Route::prefix('manual-tikcet')->group(function () {
    Route::get('create', 'BackEnd\Organizer\SupportTicketController@create_manual')->name('organizer.manual.ticket.create');
    Route::post('/store', 'BackEnd\Organizer\SupportTicketController@store_manual')->name('organizer.manual.ticket.store');
    Route::get('tickets', 'BackEnd\Organizer\SupportTicketController@index_manual')->name('organizer.manual.ticket');
    Route::get('/edit/{id}', 'BackEnd\Organizer\SupportTicketController@edit_manual')->name('organizer.manual.ticket.edit');
    Route::post('/update/{id}', 'BackEnd\Organizer\SupportTicketController@update_manual')->name('organizer.manual.ticket.update');

    Route::post('/delete/{id}', 'BackEnd\Organizer\SupportTicketController@delete_manual')->name('organizer.manual.ticket.delete');
    Route::post('/bulk/delete/', 'BackEnd\Organizer\SupportTicketController@bulk_delete_manual')->name('organizer.manual.ticket.bulk_delete');
    Route::get('/sendmail_manual/{id}', 'BackEnd\Organizer\SupportTicketController@sendmail_manual')->name('organizer.manual.ticket.sendmail_manual');
    Route::get('/view/{id}', 'BackEnd\Organizer\SupportTicketController@ticket_view_manual')->name('organizer.manual.ticket.view');
  });
});
