...
Route::prefix('/admin')->middleware(['auth:admin'])->group(function () {
  ...
  Route::group(['middleware' => 'permission:Event Management'], function () {
    ...
    Route::get('event-management/events-approval', 'BackEnd\Event\EventController@index2')->name('admin.event_management.event-approval');
    Route::get('event-management/events-approval/{id}', 'BackEnd\Event\EventController@eventupdate2')->name('admin.event_management.event-approval.update');
