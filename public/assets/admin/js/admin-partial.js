...
$(document).ready(function () {
  ...
  $('.eventDateType2').on('change', function () {
    let value = $(this).val();
    if (value == 'multiple') {
      $('#single_dates').addClass('d-none');
  ...
  $('.addDateRow2').on('click', function () {
    ...
    var tr = `<tr>
                <td>
                  ...
                  <input type="hidden" name="m_start_date[]" class="form-control hidden_date" value="`+date+`">
                  </div>
                </td>
                <td>
                  <div class="form-group">
