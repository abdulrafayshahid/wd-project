...
$(function ($) {
  ...
  $("#submitBtn").on('click', function (e) {
    ...
    let ajaxForm = document.getElementById('foodDrinksForm');
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.status == 'success') {
        ...
        var url = 'https://wanderguide.fun/admin/event-management/events?language=en';
...
$("#EventSubmitadminupdate").on('click', function (e) {
  $(e.target).attr('disabled', true);
  $(".request-loader").addClass("show");
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.status == 'success') {
        ...
        // Construct the URL
        var url = 'https://wanderguide.fun/organizer/event/ticket?language=en&event_id=' + eventId + '&event_type=venue';
...
$("#EventSubmitupdate").on('click', function (e) {
  $(e.target).attr('disabled', true);
  $(".request-loader").addClass("show");
...
$(document).ready(function () {
  ...
  $('.featured-ok').click(function () {
    $('#exampleModalCenter').modal('hide');
  });
  $('.featured_day_input').on('keyup', function () {
    var a = $(this).val();
    $('.date-inp').remove();

    for (let index = 0; index < a; index++) {
      $('.featured_day').append('<input type="date" name="is_featured_date[]" class="form-control date-inp">');
    }
  });
