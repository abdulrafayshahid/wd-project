...
class EventController extends Controller
{
  ...
  public function index(Request $request)
  {
    ...
    $dateToFind = Carbon::now()->toDateString();
    ...
    try {
      ...
      if ($tickets_count < 1) {
        $content = EventContent::join('events', 'events.id', 'event_contents.event_id')
          ...
          ->where('event_contents.language_id', $language->id)
          ->where('events.id', $id)
          ->select('events.*','event_contents.food_drink','event_contents.transportation', 'event_contents.Guide_activity_info','event_contents.title', 'event_contents.slug as eventSlug', 'event_contents.description', 'meta_keywords', 'meta_description', 'event_contents.event_category_id', 'event_categories.name', 'event_categories.slug', 'event_contents.city', 'event_contents.state', 'event_contents.country', 'event_contents.address', 'event_contents.zip_code'
          , 'event_contents.refund_policy'
         , 'event_contents.main_inclusions'
           , 'event_contents.inclusion_optional_description'
                    , 'event_contents.inclusion_short_description'
                             , 'event_contents.inclusion_full_description'
                             
, 'event_contents.inclusions_activity_one'
, 'event_contents.inclusions_activity_two'
, 'event_contents.inclusions_activity_three'
        ...
        $content = EventContent::join('events', 'events.id', 'event_contents.event_id')
          ...
          ->where('event_contents.language_id', $language->id)
          ->where('events.id', $id)
          ->select('events.*', 'event_contents.transportation', 'event_contents.food_drink','event_contents.Guide_activity_info','event_contents.title', 'event_contents.slug as eventSlug', 'event_contents.description', 'meta_keywords', 'meta_description', 'event_contents.event_category_id', 'event_categories.name', 'event_categories.slug', 'tickets.price', 'tickets.variations', 'tickets.pricing_type', 'event_contents.city', 'event_contents.state', 'event_contents.country', 'event_contents.address', 'event_contents.zip_code', 'event_contents.refund_policy'
