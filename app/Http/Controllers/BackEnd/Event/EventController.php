...
class EventController extends Controller
{
  ...
  public function index2(Request $request)
  {
    ...
    $information['events'] = $events;
    return view('backend.event.index2', $information);
  }
  //choose_event_type
  public function eventupdate2($id)
  {
    $event = Event::find($id);
    $event->admin_approval = 1;
    $event->update();
  ...
  public function gallerystore(Request $request)
  {
    ...
    $messages = [
      'file' => 'The file has invalid image dimensions ' . $img->getClientOriginalName()
    ];
