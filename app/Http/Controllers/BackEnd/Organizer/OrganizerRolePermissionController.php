...
class OrganizerRolePermissionController extends Controller
{
    public function index()
    {
      $roles = RolePermission::where('user_id',auth()->user()->id)->orderBy('id', 'desc')->get();
  
      return view('organizer.role-permission.index', compact('roles'));
    }
    ...
    public function permissions($id)
    {
      ...
      return view('organizer.role-permission.permissions', compact('role'));
    }
