...
class OrganizerController extends Controller
{
  ...
  public function index()
  {
    ...
    $information['total_events'] = Event::where('organizer_id', Auth::guard('organizer')->user()->id)->get()->count();
      ...
      $information['total_events'] = Event::where('organizer_id', $user)->get()->count();
    }
    if(empty($user)){
      $information['total_event_bookings'] = Booking::where('organizer_id', Auth::guard('organizer')->user()->id)->get()->count();
    }else{
      $information['total_event_bookings'] = Booking::where('organizer_id', $user)->get()->count();
    }
    if (empty($user)) {
      $information['transcation_count'] = Transaction::where('organizer_id', Auth::guard('organizer')->user()->id)->get()->count();
      
    }else{  
      $information['transcation_count'] = Transaction::where('organizer_id', $user)->get()->count();
    }
  ...
  public function create(Request $request)
  {
    ...
    $request->validate([
      ...
      'company_or_individual' => 'required',
      'username' => [
        'required',
        'alpha_dash',
        'unique:organizers',
